...
export const TestStudioLogo = () => (
    <div className="flex items-center">
        <img src="/assets/logo.png" alt="TestStudio" className="h-10 w-auto object-contain" />
    </div>
);
...
export const FolderIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0114.25 12v.75m-8.5-3.75h8.5m-8.5 0a2.25 2.25 0 00-2.25 2.25v8.25a2.25 2.25 0 002.25 2.25h8.5a2.25 2.25 0 002.25-2.25V11.25a2.25 2.25 0 00-2.25-2.25h-8.5z" /></Icon>
);
